export const metadata = {
  ...
  configFields: [
    ...
    { name: 'step', type: 'number', label: 'Pas', default: 1 },
    {
      ...
      options: ['decimal', 'fraction', 'mixed'],
      default: 'decimal'
    },
    { name: 'denominators', type: 'text', label: 'Dénominateurs (ex: 2,4,10)', default: '2,4,5,10' },
    ...
    { name: 'height', type: 'number', label: 'Hauteur (px)', default: 100 },
